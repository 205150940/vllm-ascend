...
class ScaleDownHelper:
    ...
    def init_dp_cpu_group(self,new_stateless_dp_group_port) -> None:
        init_dp_cpu_group_impl(self.vllm_config,new_stateless_dp_group_port)
...
def init_dp_cpu_group_impl(vllm_config: VllmConfig,new_stateless_dp_group_port) -> None:
...
def reconfigure_moe(
    ...
    for cur_layer_id, module in enumerate(moe_modules):
        ...
        module.moe_config = FusedMoEConfig(
            ...
            max_num_tokens=SchedulerConfig.DEFAULT_MAX_NUM_BATCHED_TOKENS_FOR_BATCHED_DP,
            has_bias=False,
            is_act_and_mul=True,
